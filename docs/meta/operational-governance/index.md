...
- **[Change classification](./change-classification/)**  
  Defines the impact categories of changes and their governance consequences.

- **[Contribution workflow](./contribution-workflow/)**  
  Defines the stages through which issues and changes progress, including reporting, classification, review, approval, and escalation.

### Authority

- **[Roles and authority](./roles-and-authority/)**  
  Defines governance actors and their decision rights within the workflow.

### Operational instruments

- **[Templates](./templates/)**  
  Defines the canonical authoring templates used to instantiate compliant pages.

- **[Decision records](./decision-records/)**  
  Defines how governance decisions are documented and preserved.
