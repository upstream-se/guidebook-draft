...
> This page defines the boundaries of the guidebook and clarifies what it does not attempt to cover.
...
This page is reserved for defining the scope and non-goals of the guidebook.  It will clarify what the guidebook covers and what it explicitly excludes.
