...
> Not merely how to decompose systems —  
> but how to design abstractions that could survive change and uncertainty.

This era saw the consolidation of object-oriented thinking, iterative risk-driven development, and stronger abstraction mechanisms.

Key works include object-oriented design methods (see [Booch, 1986](../../../resources/bibliography.md#booch-1986)), object-oriented programming foundations (see [Stroustrup, 1983](../../../resources/bibliography.md#stroustrup-1983)), use-case driven development (see [Jacobson, 1987](../../../resources/bibliography.md#jacobson-1987)), and spiral risk management (see [Boehm, 1986](../../../resources/bibliography.md#boehm-1986)).


## What problem was foregrounded?

The dominant problem of this era was **uncertainty under complexity**:

- Requirements evolved during development.
- Large systems needed conceptual cohesion.
- Long-term adaptability became critical.
- Technical risk accumulated across extended lifecycles.

The concern was no longer only decomposition or stage control, but **how to structure systems to accommodate change without structural collapse**.
...
Governance expanded from lifecycle sequencing to **risk-informed structural adaptation**.


## What governance mode dominated?

This era was characterized by a strengthening of **Managerial × Structural governance**, with early movement toward epistemic structuring.

- Structural design became more abstract and domain-oriented.
- Iteration was justified through explicit risk reasoning.
- Conceptual integrity gained renewed emphasis.
...
Despite conceptual advances:

- System-level intent was still primarily captured through requirements documents and use cases.
