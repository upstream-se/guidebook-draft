...
The purpose of this analysis is to examine how existing approaches address different portions of the upstream problem space.  Each approach is considered in terms of how governance is enacted and which aspects of the software system are primarily treated as governable.  Taken together, these analyses allow patterns of coverage to be observed systematically across approaches.
...
Rather than evaluating individual methods or frameworks in isolation, the analysis focuses on how different classes of approaches enact governance and what knowledge objects they explicitly govern.  This structured comparison makes it possible to reason about coverage in a consistent and comparable manner.
...
- **[Project and Portfolio Management Approaches](./project-and-portfolio.md)**  
  Analyzes time-bounded and initiative-centric approaches using the same analytical frame.
...
- **Aggregate Coverage and Observed Patterns**  
  Synthesizes the preceding analyses to examine coverage patterns across the matrix.
...
The subsequent pages apply this lens to different families of approaches.  After reading the individual analyses, the aggregate synthesis can be consulted to understand broader patterns across the governance–knowledge matrix.