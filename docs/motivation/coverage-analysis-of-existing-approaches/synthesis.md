...
In contrast, **Epistemic × Intentional governance remains comparatively sparse across families**.  No analyzed family strongly activates this configuration.  Where intent is articulated, it is typically framed managerially—as plans, roadmaps, objectives, or compliance constraints—rather than epistemically, as durable and revisitable knowledge about system-level purpose, assumptions, non-goals, and long-term commitments.

The most structurally significant feature of the matrix is therefore not merely variation in intensity, but the absence of strong activation in the Epistemic × Intentional intersection.  This configuration would correspond to sustained stewardship of system-level intent as a knowledge asset—explicitly articulated, inspectable, revisitable, and governable across initiatives and organizational transitions.

The asymmetry is structural rather than incidental.  Governance of activity, coordination, investment, and structure is well supported in contemporary approaches.  Governance of durable system intent as epistemic knowledge is not systematically foregrounded.
